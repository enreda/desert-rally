package  
{
	 ...
	 * @author Zaid Abdulla
	 */
	public class StartLine extends GameObject
	{
		...
		public function StartLine(_x:Number, _y:Number, _width:Number, _height:Number, ground:Ground)
		{
			x = _x;
			y = _y;
			width = _width;
		...
		private function drawLine(b:BitmapData):void
		{
			...
			shp.graphics.moveTo(0, b.height - 10);
			shp.graphics.lineTo(b.width, b.height - 10);
		...
		private function drawText(b:BitmapData):void
		{
			...
			var textElement:TextElement = new TextElement("خط البداية", elementFormat);
